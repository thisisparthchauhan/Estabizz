...
const FULL_PATH = '/rbi/nbfc-for-sale';

export const dynamic = 'force-dynamic';

const FALLBACK_METADATA: Metadata = {
    title: "NBFC for Sale in India: Ultimate Guide to Buy NBFC Safely & Legally",
    description: "Complete guide and compliance information for buying or acquiring an NBFC in India under RBI regulatory framework.",
