            ...
            {searchable && (
                <div className="rounded-2xl border border-blue-100 bg-white p-4 shadow-sm">
                    ...
                    <input
                        ...
                        className="w-full rounded-xl border border-blue-100 bg-[#f8faff] px-4 py-3 text-[14px] font-medium text-[#0a1628] outline-none focus:border-[#1677f2] focus:ring-4 focus:ring-[#1677f2]/10"
                    />
                </div>
            )}
                        ...
                        {items.map((faq) => (
                            <details key={faq.question} className="group rounded-xl border border-gray-100 bg-[#fbfdff] p-4">
                                <summary className="flex cursor-pointer list-none items-start justify-between gap-4 text-[14px] font-bold text-[#0a1628]">
                                    ...
                                    <span className="mt-0.5 text-[#1677f2] transition-transform group-open:rotate-45">+</span>
                                </summary>
