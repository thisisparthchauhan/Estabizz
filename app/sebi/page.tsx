    ...
    return (
        ...
        <div className="bg-[#f8faff] min-h-screen pt-16">
            <section className="relative py-16 px-6 border-b border-blue-100 overflow-hidden"
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <nav className="text-sm font-medium text-gray-500 mb-6 flex items-center space-x-2">
                        ...
                        <span>&gt;</span>
                        <span className="text-[#0096D6]">SEBI Services</span>
                    </nav>
                    <span className="px-3 py-1 bg-blue-50 text-[#0096D6] border border-blue-100 rounded-full text-xs font-semibold mb-4 inline-block">📈 Securities & Exchange Board of India</span>
                    <h1 className="text-[40px] font-black text-[#0a1628] leading-tight mb-4 tracking-tight">SEBI Services in India</h1>
                    <p className="text-[17px] text-gray-600 max-w-2xl mb-8">Complete SEBI regulatory services – registration, compliance and licensing for mutual funds, AIFs, depository participants, credit rating agencies and more.</p>
            ...
            <section className="max-w-7xl mx-auto px-6 py-16">
                <h2 className="text-[28px] font-black text-[#0a1628] mb-3">SEBI Regulatory Services</h2>
                <p className="text-gray-500 mb-10">Complete regulatory guides with eligibility criteria, registration process, documents, fees and FAQs.</p>
            ...
            <section className="bg-gradient-to-br from-[#0a1628] to-[#1a2b45] py-16 text-center px-6">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-[28px] font-bold text-white mb-4">Need Expert SEBI Compliance Guidance?</h2>
                    <p className="text-blue-100 mb-8">Our team specialises in SEBI registration, AIF compliance, mutual fund regulations and securities law in India.</p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <a href="tel:+919825600907" className="px-8 py-3.5 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl border border-white/20">Talk to Expert</a>
                    </div>
                </div>
            </section>
        </div>
