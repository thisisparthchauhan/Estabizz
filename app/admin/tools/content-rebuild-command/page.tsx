                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_360px]">
                    ...
                    <aside className="space-y-6">
                        <div className="sticky top-6 rounded-3xl bg-[#0a1628] p-7 text-white shadow-[0_24px_70px_rgba(10,22,40,0.22)]">
                            ...
                            <Link href="/admin/tools/service-page-content-framework" className="block rounded-xl bg-[#1677f2] px-5 py-3 text-center text-sm font-black text-white">Open Service Page Framework</Link>
                            <Link href="/admin/tools/proposal-template" className="mt-3 block rounded-xl border border-white/25 px-5 py-3 text-center text-sm font-black text-white">Open Proposal Template</Link>
                        </div>
                    </aside>
                </div>
            </div>
