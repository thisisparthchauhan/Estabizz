...
import RegulatoryUpdatesClient from "./RegulatoryUpdatesClient";

export const metadata: Metadata = {
  title: "Regulatory Update Desk — Estabizz Admin",
...
export default async function RegulatoryUpdatesAdminPage() {
  const viewer = await getViewer();
  return <RegulatoryUpdatesClient viewer={viewer} />;
}
