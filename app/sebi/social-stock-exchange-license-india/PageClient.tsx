    ...
    >
      ...
      <Section id="speak-to-expert" title="Speak to SEBI Compliance Expert">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-6">
          ...
          <Link href="/contact" className="px-6 py-3 bg-white text-[#1677f2] font-bold rounded-xl border border-blue-200 text-center">Apply for Social Stock Exchange Registration</Link>
