  ...
  return (
    ...
    >
      ...
      <Section id="annual-compliance-calendar-for-aif-indicative" title={"Annual Compliance Calendar for AIF (Indicative)"}>
        <DataTable headers={["Month", "Compliance Activity"]} rows={[["February–March", "Data compilation and internal compliance review through the year end"], ["April", "CTR prepared and submitted to the Trustee and Sponsor, within 30 days of financial year end"], ["May", "Trustee or Sponsor observations intimated to the Manager, within 30 days of their receiving the CTR"], ["June–July", "Rectification of observations; financial statements and audit"], ["Ongoing", "Event-based reporting, quarterly and annual filings, record maintenance"]]} />
        <p>{"Indicative only, and assumes a financial year ending 31 March. The statutory point is the 30-day window after year end; the surrounding months are planning guidance."}</p>
      </Section>
