...
const FULL_PATH = '/rbi/nbfc-financial-modeling';

export const dynamic = 'force-dynamic';

const FALLBACK_METADATA: Metadata = {
    title: "NBFC Financial Modelling: Insights for Smart & Compliant Growth",
    description: "Complete guide and compliance information for NBFC Financial Modelling in India under RBI framework.",
