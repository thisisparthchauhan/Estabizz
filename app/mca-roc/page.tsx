...
export const metadata: Metadata = {
  title: "MCA / ROC Corporate Services | Company Registration & Compliance — Estabizz",
  description:
    "Estabizz Fintech MCA & ROC corporate services — company registration, LLP, OPC, change of name, appointment of directors and allied compliance support for Indian businesses.",
  alternates: { canonical: "/mca-roc" },
  robots: { index: true, follow: true },
};

export default function McaRocIndex() {
  return (
      ...
      <header className="relative isolate overflow-hidden border-b border-blue-100 bg-white">
        ...
        <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6 sm:py-16">
          <nav className="mb-5 flex items-center gap-2 text-[12px] text-[#94a3b8]" aria-label="Breadcrumb">
            ...
            <span className="text-[#374151]">MCA / ROC Corporate Services</span>
          </nav>
