...
export const PAGES: PageEntry[] = [
  {
    ...
    sections: [
      ...
      { key: 'homepage.globalMarkets',   name: 'Global Market Desk',                                                  editorReady: true },
      { key: 'homepage.solutions',       name: 'Business Stage Solutions',        note: 'Audience cards',             editorReady: true },
      { key: 'homepage.whyChooseUs',     name: 'Why Estabizz',                                                        editorReady: true },
      { key: 'homepage.regulatoryServices', name: 'Regulatory Services',          note: 'Service categories',         editorReady: true },
      { key: 'homepage.process',         name: 'Execution Process',                                                   editorReady: true },
      { key: 'homepage.caseStudies',     name: 'Regulatory Experience / Case Highlights',                             editorReady: true },
      { key: 'homepage.compliancePortal', name: 'Compliance Portal',                                                  editorReady: true },
      { key: 'homepage.testimonials',    name: 'Testimonials',                                                        editorReady: true },
      { key: 'homepage.contentFramework', name: 'Content, Compliance & Trust',                                        editorReady: true },
      { key: 'homepage.resources',       name: 'Resource Architecture',                                               editorReady: true },
      { key: 'homepage.finalCta',        name: 'Final CTA',                                                           editorReady: true },
      { key: 'global.footer',            name: 'Footer Section',                  note: 'Bottom of every page',       editorReady: true },
      { key: 'seo.homepage',             name: 'SEO Settings',                    note: 'Search engine listing',      editorReady: true },
    ],
  },
];
