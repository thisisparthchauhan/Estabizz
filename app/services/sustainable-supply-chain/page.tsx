...
const FULL_PATH = '/services/sustainable-supply-chain';

export const dynamic = 'force-dynamic';

const FALLBACK_METADATA: Metadata = {
    title: 'Sustainable Supply Chain Management: Key Benefits & Essential Compliance Guide in India',
    description: 'Sustainable Supply Chain Management in India explained – ESG integration, regulatory requirements, compliance standards, and best practices for businesses.',
