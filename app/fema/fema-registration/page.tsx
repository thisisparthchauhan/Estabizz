...
const FULL_PATH = '/fema/fema-registration';

export const dynamic = 'force-dynamic';

const FALLBACK_METADATA: Metadata = {
    title: 'FEMA Registration in India: Guide to Compliance Requirements',
    description: 'FEMA Registration in India explained in detail. Learn about Foreign Exchange Management Act registration obligations, RBI filings, compliance requirements and penalties.',
