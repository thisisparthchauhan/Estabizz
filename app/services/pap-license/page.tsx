...
const FULL_PATH = '/services/pap-license';

export const dynamic = 'force-dynamic';

const FALLBACK_METADATA: Metadata = {
    title: 'TPA License India: Complete Guide to IRDAI Registration, Eligibility & Compliance',
    description: 'TPA License India explained – IRDAI registration process, eligibility, documents, fees, and compliance requirements for Third Party Administrators.',
