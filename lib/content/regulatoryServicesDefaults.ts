...
export const REGULATORY_SERVICES_DEFAULTS: RegulatoryServicesContent = {
  ...
  services: [
    ...
    { id: "sebi", icon: "📈", title: "SEBI Regulatory Services", href: "/sebi", forText: "Capital Market & Investment Entities", desc: "Structured SEBI registration and governance support covering documentation, eligibility assessment, net worth compliance, application filing, regulatory query response and long-term compliance monitoring.", tags: [
      ...
      { name: "RTA", href: "/sebi/rta-registration-in-india" },
    ...
    { id: "fiu", icon: "🔍", title: "Financial Intelligence & Reporting Frameworks", href: "/fiu-ind-aml", forText: "AML, KYC & Reporting Teams", desc: "Design and implementation of financial intelligence, AML, KYC, reporting and risk-monitoring systems aligned with India's financial regulatory expectations.", tags: [
      { name: "FIU-IND", href: "/fiu-ind-aml/fiu-ind-registration" },
      { name: "PMLA Compliance", href: "/fiu-ind-aml/pmla-compliance-advisory" },
      { name: "AML Policy", href: "/fiu-ind-aml/aml-policy-drafting" },
      { name: "AML Risk Assessment", href: "/fiu-ind-aml/aml-risk-assessment" },
      { name: "CKYC", href: "/fiu-ind-aml/ckyc-registration-reporting" },
      { name: "Credit Bureau Integration", href: "/services/enterprise-services" },
      { name: "NESL Reporting", href: "/services/enterprise-services" },
    ] },
    { id: "company", icon: "🏛️", title: "Company Formation & Governance", href: "/mca-roc", forText: "Founders, Boards & Corporate Teams", desc: "From incorporation to structured governance — building legally compliant enterprises with strong financial and operational discipline.", tags: [
      { name: "Private Limited", href: "/mca-roc/company-registration-in-india" },
      { name: "LLP", href: "/mca-roc/llp-registration-india" },
      { name: "OPC", href: "/mca-roc/one-person-company-registration-india" },
      { name: "Section 8", href: "/mca-roc/ngo-registration-in-india" },
    ...
    { id: "sectoral", icon: "⚙️", title: "Sectoral & Operational Licences", href: "/gov-lic", forText: "Manufacturing, Food, Healthcare & Export Businesses", desc: "Industry-specific regulatory approvals enabling businesses to operate legally across manufacturing, healthcare, food, exports, and certification.", tags: [
      { name: "FSSAI", href: "/gov-lic/fssai-licence" },
      { name: "APEDA", href: "/gov-lic/apeda-registration" },
      { name: "AYUSH", href: "/gov-lic/ayush-licence" },
      { name: "Factory Licence", href: "/gov-lic/factory-licence" },
      { name: "Drug Licence", href: "/gov-lic/drug-licence" },
      { name: "RNI", href: "/services/enterprise-services" },
      { name: "BIS", href: "/gov-lic/bis-certification" },
      { name: "Trademark", href: "/services/trademark-search" },
    ] },
    { id: "specialised", icon: "📋", title: "Specialised Compliance Support", href: "/regulatory/compliance", forText: "Regulated Financial Entities", desc: "Ongoing regulatory monitoring, returns filing, audit coordination, policy drafting, and inspection readiness for market participants.", tags: [
