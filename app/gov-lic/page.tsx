...
export const metadata: Metadata = {
  ...
  description:
    "Expert assistance for FSSAI, APEDA, AYUSH, Factory Licence, Drug Licence, BIS Certification and PFRDA registrations for businesses operating in regulated sectors.",
      ...
      <header className="relative isolate overflow-hidden border-b border-blue-100 bg-white">
        ...
        <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6 sm:py-16">
          <nav className="mb-5 flex items-center gap-2 text-[12px] text-[#94a3b8]" aria-label="Breadcrumb">
            ...
            <span className="text-[#374151]">Government Licences</span>
          </nav>
          ...
          <h1 className="mt-4 text-[34px] font-black leading-[1.08] tracking-[-0.03em] text-[#120b45] sm:text-[46px]">
            Government <span className="text-[#1677f2]">Licences</span>
          </h1>
          <p className="mt-4 max-w-2xl text-[16px] font-medium leading-[1.7] text-[#475569] sm:text-[18px]">
            Sector-specific licence applications, registrations and ongoing
            compliance management for businesses operating in regulated industries.
          </p>
