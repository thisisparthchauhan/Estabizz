...
import { PROCESS_DEFAULTS, type ProcessContent } from "@/lib/content/processDefaults";

export default function ProcessSection({ content }: { content?: Partial<ProcessContent> }) {
    const c: ProcessContent = { ...PROCESS_DEFAULTS, ...content };
    const steps = c.steps?.length ? c.steps : PROCESS_DEFAULTS.steps;
