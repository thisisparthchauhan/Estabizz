...
const FULL_PATH = '/rbi/nbfc-legal-support';

export const dynamic = 'force-dynamic';

const FALLBACK_METADATA: Metadata = {
    title: "NBFC Legal Support Services in India: Complete Compliance Guide",
    description: "Complete guide and compliance information for NBFC Legal Support Services in India covering RBI regulatory framework, documentation and advisory support.",
