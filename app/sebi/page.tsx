...
const services = [
    ...
    { href: "/sebi/alternative-asset-portfolio-valuation", title: "Alternative Asset Portfolio Valuation", desc: "SEBI framework for valuation of alternative assets and portfolio management.", tag: "SEBI", emoji: "💼" },
    { href: "/sebi/collective-investment-schemes", title: "Collective Investment Schemes", desc: "Regulatory framework for collective investment schemes in India under SEBI.", tag: "SEBI", emoji: "🏦" },
    { href: "/sebi/aif-compliance-test-report", title: "AIF Compliance Test Report", desc: "Compliance test report requirements for Alternative Investment Funds.", tag: "SEBI", emoji: "📋" },
    { href: "/sebi/credit-rating-agency", title: "Credit Rating Agency Registration", desc: "SEBI registration process for credit rating agencies operating in India.", tag: "SEBI", emoji: "⭐" },
    ...
    { href: "/sebi/stock-broker-registration-in-india", title: "Stock Broker Registration in India", desc: "Professional support for SEBI Stock Broker Registration covering NSE / BSE membership planning, trading and clearing structure, net worth and capital readiness, infrastructure inspection, margin policy, client fund segregation, exchange documentation, SEBI registration and post-registration compliance.", tag: "SEBI", emoji: "🏛️" },
    ...
    return (
        <main className="min-h-screen bg-white pt-[64px]">
            <header className="relative isolate overflow-hidden border-b border-blue-100 bg-white">
                ...
                <div className="mx-auto max-w-7xl px-6 py-14 sm:py-16">
                    <nav className="mb-5 flex items-center gap-2 text-[12px] text-[#94a3b8]" aria-label="Breadcrumb">
                        ...
                        <span className="text-[#374151]">SEBI Services</span>
                    </nav>
                    ...
                    <h1 className="mt-4 text-[34px] font-black leading-[1.08] tracking-[-0.03em] text-[#120b45] sm:text-[44px]">
                        SEBI Services <span className="text-[#1677f2]">in India</span>
                    </h1>
                    <p className="mt-4 max-w-2xl text-[16px] font-medium leading-[1.7] text-[#475569] sm:text-[18px]">
                        Complete SEBI regulatory services – registration, compliance and licensing for mutual funds, AIFs, depository participants, credit rating agencies and more.
                    </p>
            ...
            <section className="mx-auto max-w-7xl px-6 py-14">
                <div className="mb-8">
                    <h2 className="text-[26px] font-black tracking-[-0.02em] text-[#120b45]">SEBI Regulatory Services</h2>
                    <div className="mt-2 h-[3px] w-12 rounded-full bg-[#1677f2]" />
                    <p className="mt-3 text-[14px] text-[#64748b]">Complete regulatory guides with eligibility criteria, registration process, documents, fees and FAQs.</p>
                </div>
                        ...
                        <Link key={i} href={s.href} className="group block">
                            <div className="flex h-full flex-col rounded-2xl border border-blue-100 bg-white p-6 shadow-[0_8px_30px_rgba(0,80,140,0.06)] transition-all hover:-translate-y-1 hover:border-[#1677f2]/40 hover:shadow-[0_16px_44px_rgba(0,80,140,0.12)]">
                                ...
                                <div className="mt-4 inline-flex items-center gap-1.5 text-[13px] font-black text-[#1677f2]">
                                    {s.title === "AIF Registration in India" ? "Explore AIF Registration" : s.title === "PMS Registration in India" ? "Explore PMS Registration" : s.title === "RIA Registration in India" ? "Explore RIA Registration" : s.title === "Research Analyst Registration in India" ? "Explore Research Analyst Registration" : s.title === "Stock Broker Registration in India" ? "Explore Stock Broker Registration" : s.title === "Social Stock Exchange License in India" ? "Explore Social Stock Exchange" : "Read Guide"} <span className="transition-transform group-hover:translate-x-1">→</span>
                                </div>
                            </div>
                        </Link>
                    ))}
            ...
            <section className="mx-6 mb-16 overflow-hidden rounded-2xl border border-[#1677f2]/25 bg-gradient-to-br from-[#0a1628] to-[#0c2040] px-6 py-14 text-center sm:px-10">
                <div className="mx-auto max-w-3xl">
                    ...
                    <h2 className="mb-4 text-[26px] font-black text-white sm:text-[30px]">Need Expert SEBI Compliance Guidance?</h2>
                    <p className="mb-8 text-[14.5px] leading-[1.7] text-white/60">Our team specialises in SEBI registration, AIF compliance, mutual fund regulations and securities law in India.</p>
