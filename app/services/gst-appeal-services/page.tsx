...
const FULL_PATH = '/services/gst-appeal-services';

export const dynamic = 'force-dynamic';

const FALLBACK_METADATA: Metadata = {
    title: 'GST Appeal Services India: Complete Guide to Avoid Costly Tax Errors',
    description: 'GST Appeal Services in India explained in detail – grounds of appeal, timelines, Appellate Authority, GSTAT, High Court litigation, pre-deposit requirements, stay applications, and tax dispute strategy under GST law.',
