...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const unmigratedStaticRegulatorPages: MetadataRoute.Sitemap = [
    ...
    // Legal guides under /solutions/legal (added 2026-09-19) -- static pages,
    // not CMS-managed, so the CMS query above never sees them.
    "/solutions/legal/adulteration-of-drugs-legal-services",
    "/solutions/legal/appeal-before-high-court",
    "/solutions/legal/appeal-before-itat",
    "/solutions/legal/appeal-before-nclt",
    "/solutions/legal/bail-application",
    "/solutions/legal/cheque-bounce-in-india",
    "/solutions/legal/caveat-filing",
    "/solutions/legal/complaints-before-consumer-court",
    "/solutions/legal/contested-divorce",
    "/solutions/legal/court-marriage",
    "/solutions/legal/court-proceedings",
    "/solutions/legal/criminal-misappropriation-of-property",
    "/solutions/legal/cyber-crime-complaint",
    "/solutions/legal/cyber-security-advisory",
  ].map((path) => ({
    url: `${BASE}${path}`,
    changeFrequency: "monthly" as const,
    priority: 0.7,
