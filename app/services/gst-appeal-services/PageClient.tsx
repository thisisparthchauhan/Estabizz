  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "a": "Filing is online through the GST portal as the normal route. Manual filing has been permitted in specified circumstances, so confirm the position for your order before assuming either route.",
        "points": []
      },
      {
        "number": 37,
...
export default function PageClient() {
  return (
    ...
    >
      ...
      <Section id="orders-commonly-appealed" title={"Orders Commonly Appealed"}>
        <DataTable headers={["Order type", "Why an appeal may be filed"]} rows={[["Demand order", "Tax, interest and penalty confirmed"], ["ITC reversal order", "Input tax credit denied or reversed"], ["GSTR-2A / 2B mismatch order", "ITC mismatch demand confirmed"], ["Section 73 order", "Non-fraud tax demand confirmed"], ["Section 74 order", "Fraud or suppression-based demand confirmed"], ["Refund rejection order", "Refund rejected or only partly sanctioned"], ["Registration cancellation order", "GSTIN cancelled, or revocation rejected"], ["E-way bill detention order", "Goods or conveyance detained and penalty imposed"], ["Section 129 penalty order", "Detention and penalty demand challenged"], ["Classification order", "Wrong GST rate or classification applied"], ["Valuation dispute order", "Taxable value enhanced"], ["Export or LUT issue", "Refund or zero-rated supply dispute"]]} />
      </Section>

      <Section id="who-can-file" title={"Who Can File the Appeal"}>
        <DataTable headers={["Person or entity", "Practical position"]} rows={[["Registered taxpayer", "May appeal against an adverse GST order"], ["Proprietorship", "Proprietor files through the GST portal"], ["Partnership firm", "Partner or authorised signatory acts"], ["LLP", "Designated partner or authorised signatory acts"], ["Company", "Director or authorised signatory acts"], ["Trust or society", "Trustee or authorised person acts"], ["Exporter", "May appeal refund, LUT or zero-rated supply orders"], ["E-commerce seller", "May appeal mismatch, demand or registration orders"], ["Transporter", "May appeal detention or penalty orders"], ["Unregistered person", "May appeal where the order affects them and the law permits"], ["Department", "May file an application in the prescribed form where authorised"], ["Authorised representative", "An advocate, CA, CS, CMA or other authorised person may represent, as the law permits"]]} />
      </Section>

      <Section id="limitation-and-condonation" title={"Limitation and Delay Condonation"}>
        <DataTable headers={["Item", "Practical position"]} rows={[["Normal appeal period", "Generally 3 months from communication of the order"], ["Condonation period", "A further 1 month may be allowed where sufficient cause is shown"], ["Beyond the condonation window", "The Appellate Authority generally has limited power"], ["Departmental application", "A different timeline may apply"], ["Communication date", "The date the order was communicated is critical"], ["Portal order download", "Preserve the download and communication proof"], ["Delay reason", "Must be genuine, documented and convincing"], ["Ex parte order", "Natural justice and non-service facts should be recorded"]]} />
      </Section>

      <Section id="authority-vs-tribunal" title={"Appellate Authority vs Tribunal"}>
        <DataTable headers={["Point", "Appellate Authority", "Appellate Tribunal"]} rows={[["Stage", "First appeal", "Second appeal"], ["Main section", "Section 107", "Section 112"], ["Main form", "GST APL-01", "GST APL-05"], ["Filed against", "Adjudication order", "Appellate or Revisional Authority order"], ["Nature", "First review of the order", "Higher appellate review"], ["Fact record", "The key stage for building the factual record", "Usually depends heavily on the lower record"], ["Next remedy", "GSTAT", "High Court, on a substantial question of law"], ["Best strategy", "Build a complete fact and law file", "Challenge appellate findings and preserve legal issues"]]} />
        <p>{"Pre-deposit applies at both stages. See the pre-deposit sections above for the current percentages and caps following the Finance (No. 2) Act, 2024 amendments."}</p>
      </Section>
