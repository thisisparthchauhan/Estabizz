...
const FULL_PATH = '/fema/compliance-under-fema';

export const dynamic = 'force-dynamic';

const FALLBACK_METADATA: Metadata = {
    title: 'FEMA Compliance in India: Complete & Practical Guide for Businesses',
    description: 'FEMA Compliance in India explained in detail. Learn obligations under the Foreign Exchange Management Act, key transactions, RBI reporting, compounding, penalties and advisory support.',
